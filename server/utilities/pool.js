...
export const poolNESTIB = mysql.createPool({
...
export const poolASABA = mysql.createPool({
...
export const poolROYALPARKLANE = mysql.createPool({
...
export const poolKANO = mysql.createPool({
...
export const poolPLATINUM = mysql.createPool({
...
export const poolHYATTI = mysql.createPool({
...
export const poolSMITHCITY = mysql.createPool({
...
export const poolNESTGARKI = mysql.createPool({
...
export const poolIMPERIAL = mysql.createPool({
...
export const poolELVIS = mysql.createPool({
...
export const poolASOKORO = mysql.createPool({
...
export const poolTRANSTELL = mysql.createPool({
...
export const poolIKEJARES = mysql.createPool({

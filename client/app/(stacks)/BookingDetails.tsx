    ...
    <GestureHandlerRootView>
      <View style={styles.container}>
        ...
        <View style={styles.detailsContainer}>
          ...
          <Text style={styles.price}>₦{hotel.pricePerNight ? Number(hotel.pricePerNight).toLocaleString() : "100,000,000"} - (( 4 )) Nights</Text>
        </View>
        ...
        <Text style={styles.description}>
         ...
         <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.actionButton} onPress={() => router.push('/BookFlight')}>

...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, SafeAreaView, Animated, Modal } from "react-native";
      ...
      <Modal visible={modalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <TouchableOpacity style={styles.modalButton} onPress={() => { setModalVisible(false); router.push("/BookFlight"); }}>
              <Text style={styles.buttonText}>Book a Flight</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton} onPress={() => { setModalVisible(false); router.push("/BookRide"); }}>
              <Text style={styles.buttonText}>Book a Ride</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton} onPress={() => { setModalVisible(false); router.push("/OrderFood"); }}>
...
const styles = StyleSheet.create({
  ...
  tab: { paddingVertical: 8, paddingHorizontal: 20, borderRadius: 15, backgroundColor: "#6a5c5c", marginRight: 10 },

...
const ForgotPassword = () => {
  ...
  const handleSendOTP = () => {
    ...
    axios.post('http://172.20.10.3:5001/send-otp', { email: email.trim().toLowerCase() })
      .then(() => {
        setStep(2);
  ...
  const handleVerifyOTP = () => {
    ...
    axios.post('http://172.20.10.3:5001/verify-otp', { email, otp })
      .then(() => {
        setStep(3);
  ...
  const handleResetPassword = () => {
    ...
    axios.post('http://172.20.10.3:5001/reset-password', { email, newPassword })
      .then(() => {

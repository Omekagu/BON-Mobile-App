...
const ForgotPassword = () => {
  ...
  const handleSendOTP = () => {
    ...
    axios
      .post('http://10.0.1.20:5001/auth/send-otp', {
  ...
  const handleVerifyOTP = () => {
    ...
    axios
      .post('http://10.0.1.20:5001/auth/verify-otp', { email, otp })
      .then(() => {
        setStep(3)
        Toast.show({
          type: 'success',
  ...
  const handleResetPassword = () => {
    ...
    axios
      .post('http://10.0.1.20:5001/auth/reset-password', { email, newPassword })
      .then(() => {
        Toast.show({
          type: 'success',
          text1: 'Success',
